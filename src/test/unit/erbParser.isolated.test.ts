...
<% end %>`;
    ...
    describe('Rails helpers detection', () => {
        it('should detect form_with as block start', () => {
        ...
        it('should detect link_to with block as block start', () => {
            const input = '<% link_to user_path(@user) do %>';
            const tokens = parser.parse(input);
